...
[wiki](https://github.com/dvbern/construct/wiki), then
[search the issue tracker](https://github.com/dvbern/construct/issues)
to see if someone else in the community has already created a ticket regarding your issue.
If not, feel free to go ahead and [make one](https://github.com/dvbern/construct/issues/new)!

### 2. Did you find a bug?

* **Ensure the bug was not already reported** by searching on GitHub
  under [Issues](https://github.com/dvbern/construct/issues).

* If you're unable to find an open issue addressing the
  problem, [open a new one](https://github.com/dvbern/construct/issues/new).
...
[fork construct](https://help.github.com/articles/fork-a-repo)
...
By beeing part of our development team and community, please abide the rules in
...
Conduct. Thank you for beeing a nice person!
...
```sh
git remote add upstream git@github.com/dvbern/construct.git
git checkout master
