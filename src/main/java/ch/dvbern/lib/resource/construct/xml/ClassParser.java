...
/**
 * Implementation of <code>ElementParser</code>. Responsible for parsing xml-tags with the element-name "class"
 * (<code>&lt;class  &gt;</code>). 
 * The parser may use other <code>ElementParser</code> instances for parsing nested elements.
 * <p>Code relies on <a href="http://www.jdom.org" target="_blank">JDOM</a>
 * <p>For a detailed description of the xml-tags see the special documentation.
 */
public class ClassParser implements ElementParser {
    
    /**
     * Method parses the passed xml-element and creates an object 
     * based on the information defined by the xml-tag.
     *
     ...
     *
     * @exception ElementParserException Thrown, if a problem occurs while parsing the xml-tag and
